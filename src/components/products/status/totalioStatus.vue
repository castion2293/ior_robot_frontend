                                ...
                                <v-tabs-items>
                                    ...
                                    >
                                        <v-card flat>
                                            <v-card-text>
                                                <v-layout row wrap>
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_1_16" :key="`input_${index + 1}`">
                                                    ...
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_17_32" :key="`input_${index + 17}`">
                                                    ...
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_33_48" :key="`input_${index + 33}`">
                                                    ...
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_49_64" :key="`input_${index + 49}`">
                                    ...
                                    >
                                        <v-card flat>
                                            <v-card-text>
                                                <v-layout row wrap>
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_101_116" :key="`input_${index + 101}`">
                                                    ...
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_117_132" :key="`input_${index + 117}`">
                                                    ...
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_133_148" :key="`input_${index + 133}`">
                                                    ...
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_149_164" :key="`input_${index + 149}`">
                                    ...
                                    >
                                        <v-card flat>
                                            <v-card-text>
                                                <v-layout row wrap>
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_201_216" :key="`input_${index + 201}`">
                                                    ...
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_217_232" :key="`input_${index + 217}`">
                                                    ...
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_233_248" :key="`input_${index + 233}`">
                                                    ...
                                                    <v-flex xs2 v-for="(input, index) in total.DIN_249_264" :key="`input_${index + 249}`">
                                ...
                                <v-tabs-items>
                                    ...
                                    >
                                        <v-card flat>
                                            <v-card-text>
                                                <v-layout row wrap>
                                                    <v-flex xs2 v-for="(output, index) in total.DOUT_1_16" :key="`output_${index + 1}`">
                                                        <div v-if="output" class="light-blue darken-1 white--text text-xs-center">{{ index + 1 }}</div>
                                                        <div v-else class="grey darken-1  white--text text-xs-center">{{ index + 1 }}</div>
                                                    </v-flex>
                                                    <v-flex xs2 v-for="(output, index) in total.DOUT_17_32" :key="`output_${index + 17}`">
                                                        <div v-if="output" class="light-blue darken-1 white--text text-xs-center">{{ index + 17 }}</div>
                                                        <div v-else class="grey darken-1 white--text text-xs-center">{{ index + 17 }}</div>
                                                    </v-flex>
                                                    <v-flex xs2 v-for="(output, index) in total.DOUT_33_48" :key="`output_${index +33}`">
                                                        <div v-if="output" class="light-blue darken-1 white--text text-xs-center">{{ index + 33 }}</div>
                                                        <div v-else class="grey darken-1 white--text text-xs-center">{{ index + 33 }}</div>
                                                    </v-flex>
                                                    <v-flex xs2 v-for="(output, index) in total.DOUT_49_64" :key="`output_${index + 49}`">
                                    ...
                                    >
                                        <v-card flat>
                                            <v-card-text>
                                                <v-layout row wrap>
                                                    <v-flex xs2 v-for="(input, index) in total.DOUT_101_116" :key="`output_${index + 101}`">
                                                        <div v-if="input" class="light-blue darken-1 white--text text-xs-center">{{ index + 101 }}</div>
                                                        <div v-else class="grey darken-1  white--text text-xs-center">{{ index + 101 }}</div>
                                                    </v-flex>
                                                    <v-flex xs2 v-for="(input, index) in total.DOUT_117_132" :key="`output_${index + 117}`">
                                                        <div v-if="input" class="light-blue darken-1 white--text text-xs-center">{{ index + 117 }}</div>
                                                        <div v-else class="grey darken-1 white--text text-xs-center">{{ index + 117 }}</div>
                                                    </v-flex>
                                                    <v-flex xs2 v-for="(input, index) in total.DOUT_133_148" :key="`output_${index + 133}`">
                                                        <div v-if="input" class="light-blue darken-1 white--text text-xs-center">{{ index + 133 }}</div>
                                                        <div v-else class="grey darken-1 white--text text-xs-center">{{ index + 133 }}</div>
                                                    </v-flex>
                                                    <v-flex xs2 v-for="(input, index) in total.DOUT_149_164" :key="`output_${index + 149}`">
                                                        <div v-if="input" class="light-blue darken-1 white--text text-xs-center">{{ index + 149 }}</div>
                                                        <div v-else class="grey darken-1 white--text text-xs-center">{{ index + 149 }}</div>
                                                    </v-flex>
                                                </v-layout>
                                    ...
                                    >
                                        <v-card flat>
                                            <v-card-text>
                                                <v-layout row wrap>
                                                    <v-flex xs2 v-for="(input, index) in total.DOUT_201_216" :key="`output_${index + 201}`">
                                                        <div v-if="input" class="light-blue darken-1 white--text text-xs-center">{{ index + 201 }}</div>
                                                        <div v-else class="grey darken-1  white--text text-xs-center">{{ index + 201 }}</div>
                                                    </v-flex>
                                                    <v-flex xs2 v-for="(input, index) in total.DOUT_217_232" :key="`output_${index + 217}`">
                                                        <div v-if="input" class="light-blue darken-1 white--text text-xs-center">{{ index + 217 }}</div>
                                                        <div v-else class="grey darken-1 white--text text-xs-center">{{ index + 217 }}</div>
                                                    </v-flex>
                                                    <v-flex xs2 v-for="(input, index) in total.DOUT_233_248" :key="`output_${index + 233}`">
                                                        <div v-if="input" class="light-blue darken-1 white--text text-xs-center">{{ index + 233 }}</div>
                                                        <div v-else class="grey darken-1 white--text text-xs-center">{{ index + 233 }}</div>
                                                    </v-flex>
                                                    <v-flex xs2 v-for="(input, index) in total.DOUT_249_264" :key="`output_${index + 249}`">
                                                        <div v-if="input" class="light-blue darken-1 white--text text-xs-center">{{ index + 249 }}</div>
                                                        <div v-else class="grey darken-1 white--text text-xs-center">{{ index + 249 }}</div>
                                                    </v-flex>
                                                </v-layout>
